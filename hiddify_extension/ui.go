...
func (e *FirstTestExtenstionHiddify) setFormData(data map[string]string) error {
...
func (e *FirstTestExtenstionHiddify) getRunningUI() ui.Form {

	return ui.Form{
		Title:       "first-test-extenstion-hiddify",
		Description: "Awesome Extension first_test_extenstion_hiddify created by miladj3",
		Fields: [][]ui.FormField{
			{{
...
func (e *FirstTestExtenstionHiddify) getStoppedUI() ui.Form {
	// Inital page
	return ui.Form{
		Title:       "first-test-extenstion-hiddify",
		Description: "Awesome Extension first_test_extenstion_hiddify created by miladj3",
...
func (e *FirstTestExtenstionHiddify) addAndUpdateConsole(message ...any) {
