...
[![inlang status badge](https://inlang.com/badge?url=github.com/miladj3/first-test-extenstion-hiddify)](https://inlang.com/editor/github.com/miladj3/first-test-extenstion-hiddify?ref=badge)
</div>

Improve existing languages or add new ones by manually editing the JSON files located in `/hiddify_extension/translations` or by using the [Inlang online editor](https://inlang.com/editor/github.com/miladj3/first-test-extenstion-hiddify).
